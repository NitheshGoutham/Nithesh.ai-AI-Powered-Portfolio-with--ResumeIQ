...
projects = [
    {
        "title": "🤖 Nithesh.ai – AI-Powered Portfolio with ResumeIQ",
        "tech": ["Streamlit", "Gemini API", "JSON", "LLMs"],
        "desc": "A fully Streamlit-based personal portfolio showcasing AI and data expertise. It features an interactive resume Q&A system powered by Gemini API with structured JSON data, eliminating hallucinations and ensuring accurate responses.",
        "features": [
            "Single-page Streamlit app with sidebar navigation and interactive sections",
            "Static question answering from structured JSON resume data (no backend required)",
            "Gemini API integration for cloud-based AI responses",
            "Dynamic project filtering and tech-stack tags",
            "Lightweight, self-contained architecture built entirely with Streamlit"
        ],
        "impact": "A centralized, interactive platform demonstrating Generative AI, LLM integration, and portfolio presentation skills to recruiters and clients.",
        "github": "https://github.com/NitheshGoutham/Nithesh.ai-AI-Powered-Portfolio-with--ResumeIQ/tree/main",
        "tags": ["Generative AI", "Portfolio", "Full Stack", "Streamlit", "Resume Q&A"]
    }
,
